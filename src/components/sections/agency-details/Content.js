                                ...
                                <div className="sidebar sticky-sidebar sidebar-left">
                                    ...
                                    <div className="sidebar-widget sidebar-widget-agent">
                                        ...
                                        <div className="media sidebar-author listing-agent">
                                            <img src={process.env.PUBLIC_URL + "/assets/img/companies/2.png"} alt="agent" />
                                            ...
                                            <Dropdown className="options-dropdown">
                                                ...
                                                <Dropdown.Menu className="dropdown-menu-right">
                                                    <ul>
                                                        <li> <Link to="tel:+123456789"> <i className="fas fa-phone" /> Call Jumpy Co.</Link> </li>
                                                        <li> <Link to="#"> <i className="fas fa-star" /> Save Agency</Link> </li>
                                                    </ul>
                                                </Dropdown.Menu>
                                            </Dropdown>
                                        </div>
